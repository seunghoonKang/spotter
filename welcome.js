...
const STRINGS = {
  en: {
    ...
    step1Body: '<span class="rec-dot"></span>Recording is capped at 2 minutes. Pin the icon in the toolbar (puzzle menu → 📌) so it\'s always one click away.',
  ...
  ko: {
    ...
    step1Body: '<span class="rec-dot"></span>녹화는 최대 2분까지. 툴바에 아이콘을 고정해두면(퍼즐 메뉴 → 📌) 클릭 한 번에 시작할 수 있습니다.',
